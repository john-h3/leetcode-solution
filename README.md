...
主要还是当时把简单题全部刷完了，在一个阶段完成之后，就没有太多的心思继续下去了。

确切的来说，这种不分主次的全面刷题的确不是好的方式，我在做题的过程中有明显的感觉到题目是存在套路的，主要还是要归纳总结。

比如对于 dp 类的题目一直都不知道怎么解决，很多解法没有形成系统的思维，所以感觉没有获得提升。

准备重新开始刷题玩，不过规划不再是以前那种全面的刷一遍了，而是有目的性的来进行。不过更新频率不会很高吧，还是看工作之余的合理安排吧。

同时为了能确实的有所提升，会开始针对题型做归纳总结，后面可能会多参与周赛吧，还是想混点积分换点东西:see_no_evil:。

另外，语言也不再局限于 java 了，有可能是 kotlin，go，js，python，也有可能是 c，c++，rust等。
